...
void Foam::o2suf_bc::updateCoeffs()
{
    if (updated())
    {
        return;
...
{
	gradient()= S_TPB_/D_os_*tao_*(kox_TPB_*Foam::exp(96485*d_phi_/8.31/T_)*(1-Cw/50)*0.975-kred_TPB_*Foam::exp(-96485*d_phi_/8.31/T_)*(Cw/50)*0.025);
}
